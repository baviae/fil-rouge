...
ansible-playbook -i host_vars/controleur_test.yml workstation.yml --ask-vault-pass -e 'ansible_python_interpreter=/usr/bin/python3' #  nous demande le mdp du vault 
